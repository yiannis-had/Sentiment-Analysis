...
if __name__ == '__main__':
    ...
    text_entry = ttk.Entry(background, width=20).grid(row=2)
    ...
    double_entry = ttk.Entry(background, width=20).grid(row=7)
    double_entry1 = ttk.Entry(background, width=20).grid(row=8)
    ...
    user_entry = ttk.Entry(background, width=20).grid(row=13)
    ...
    stream_entry = ttk.Entry(background, width=20).grid(row=16)
